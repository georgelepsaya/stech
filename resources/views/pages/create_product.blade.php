                    ...
                    <form id="create_product_page_form" action="{{action([\App\Http\Controllers\PageController::class, 'storeProduct'])}}" method="post" class="flex flex-col max-w-6xl mx-auto" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-col mt-2">
                            ...
                            <select name="company_id" id="company_id"
                                    class="mb-3 dark:bg-gray-700 bg-white rounded-md border dark:border-gray-600 border-gray-300 focus:ring-0 focus:outline-none focus:border-gray-600">
                        ...
                        <div class="flex justify-between gap-6 mt-2">
                            ...
                            <div class="flex flex-col w-full">
                                ...
                                <input class="mb-3 dark:bg-gray-700 bg-white rounded-md border dark:border-gray-600 border-gray-300 focus:ring-0 focus:outline-none focus:border-gray-600" id="release_date" name="release_date" type="date"/>
                            </div>
                        </div>
                        {{-- tags of the product --}}
                        <div class="flex flex-col mt-2">
