        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-4 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('pages.index') }}" method="GET">
                    <label class="text-lg text-bold" for="search-pages">Search for pages</label>
                    ...
                    <label for="page_type" class="block mt-2 mb-2 text-lg text-bold">What are we searching for?</label>
