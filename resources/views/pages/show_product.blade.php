<x-app-layout>
    <x-slot name="header">
        <div class="relative flex items-center">
            ...
            {{--Edit element button--}}
            <a class="absolute right-0 top-0 px-1 rounded-md bg-gray-500 hover:bg-yellow-500 text-gray-900 px-3 text-2xl" href="{{ route('pages.edit_product', $productPage->id) }}"> 
                EDIT
            </a>
        </div>
    </x-slot>
