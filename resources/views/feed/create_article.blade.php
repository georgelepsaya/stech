<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <button class="dark:bg-gray-700 bg-white dark:text-gray-200 text-gray-800 w-40 inline rounded-md ml-3 hover:bg-gray-50 shadow-sm border border-gray-200" id="submit_btn">Create the article</button>
        </div>
    </x-slot>
